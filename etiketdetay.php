...
require_once "inc/menu.php";
        ...
        INNER JOIN kategoriler ON kategoriler.kat_id = yazılar.yazi_kat_id WHERE yazi_durum = :d AND yazi_sef_etiket REGEXP :baslik");
        ...
        ?>
            <div class="eskimo-page-title">
                <h1><span><?php echo $etiket; ?> ETİKETİNE AİT İÇERİKLER </span></h1>
            </div>
            <div class="eskimo-masonry-grid">
                <div class="eskimo-two-columns" data-columns>
                    ...
                    WHERE yazi_durum = :d AND yazi_sef_etiket REGEXP :baslik ORDER BY yazi_id DESC LIMIT :goster, :lim");
                ...
                <?php
                    ...
                    echo '<div class="alert alert-danger" role="alert">Üzgünüm, '.$etiket.' kelimesine yazılmış herhangi bir içerik bulamadım.</div>';
                }
                ?>
            </div>
