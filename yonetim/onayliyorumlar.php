        ...
        <div class="col-md-12">
          <div class="tile">
              ...
              if ($s > ceil($toplam/$lim)){ $s = 1; }
                    if ($sorgu->rowCount()){
              ?>
            <h3 class="tile-title">Onaylı Yorumlar Listesi</h3>
            <div class="table-responsive table-hover">
                ...
                <tbody>
                  <?php foreach ($sorgu as $row) { ?>
                      ...
                      <tr>
                          ...
                          <td><a href="<?php echo $yonetim."/islemler.php?islem=yorumoku&id=".$row['yorum_id']; ?>"><i class="fa fa-eye"></i></a> | Düzenle
                              <br>
              ...
              <?php }else{
                        echo '<div class="alert alert-info">Onaylı Yorum Bulunmuyor.</div>';
                    }
