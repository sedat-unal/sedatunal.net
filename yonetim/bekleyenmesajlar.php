    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Bekleyen Mesaj Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Mesajlar</li>
          <li class="breadcrumb-item active"><a href="#">Bekleyen Mesaj Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
              ...
              $s = @intval(get('s'));
              if (!$s){ $s = 1; }
              $toplam = say('mesajlar', 'mesaj_durum', '2');
              $lim    = 25;
              $goster = $s * $lim - $lim;
              ...
              if ($s > ceil($toplam/$lim)){ $s = 1; }
                    if ($sorgu->rowCount()){
              ?>
            <h3 class="tile-title">Bekleyen Mesaj Listesi</h3>
            <div class="table-responsive table-hover">
                ...
                <tbody>
                  <?php foreach ($sorgu as $row) { ?>
                      ...
                      <tr>
                          ...
                          <td><a href="<?php echo $yonetim."/islemler.php?islem=mesajoku&id=".$row['mesaj_id']; ?>"><i class="fa fa-eye"></i></a> | Düzenle
                              <br>
                              <a onclick="return confirm('Mesaj silinecek onaylıyor musunuz ?');" href="<?php echo $yonetim."/islemler.php?islem=mesajisil&id=".$row['mesaj_id']; ?>"><i class="fa fa-eraser"></i></a> | Sil
                          </td>
                      </tr>
                  ...
                  <?php   } ?>
                        ...
                        <ul class="pagination">
                            <?php
                            if ($toplam > $lim){
                                pagination($s,ceil($toplam/$lim), 'bekleyenmesajlar?s=');
                            }
              ...
              <?php }else{
                        echo '<div class="alert alert-info">Bekleyen Mesaj Bulunmuyor.</div>';
                    }
